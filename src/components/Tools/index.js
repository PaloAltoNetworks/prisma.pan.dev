...
const toolList = [
  ...
  },
  {
    ...
    toPage: '/docs/cloud/cwpp/cwpp-gs',
    description: <>Learn more about our Cloud Compute API.</>,
  },
  {
    title: <>Terraform Provider</>,
    imageUrl: '/img/terraform.svg',
    toSite: 'https://registry.terraform.io/providers/PaloAltoNetworks/prismacloud/latest/docs',
  ...
  },
  {
    ...
    description: <>Prevent cloud misconfigurations during build time with Checkov.</>,
  },
];
