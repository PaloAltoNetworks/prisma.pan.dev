...
If you opt to continue using the v1 API endpoints, please adhere to the following guidelines:
* Review the list of v1 endpoints you are using and make sure the corresponding versioned endpoints are available.
v1 API is a larger subset and not all endpoints are supported. 
