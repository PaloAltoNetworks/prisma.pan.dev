...
For more information on accessing the API, see <a href="/docs/cloud_compute/compute_api" target="_self">Accessing the API</a>
...
* You will be making API calls. For more information, refer to <a href="/docs/cloud_compute/compute_api" target="_self">Accessing the API</a>
