...
- **`git clone`** - creates a local copy of the repository for you to work in
  ...
  ```bash
  git clone https://github.com/username/prisma.pan.dev.git
  ```
...
- **`git push`** takes a commit and pushes it to the repository
  ...
  Use this to push the changes to the repository where you can share them with others or merge them into the master branch
