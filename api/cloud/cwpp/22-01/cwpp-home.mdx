---
id: cwpp-home
title: CWPP API - 22.01
sidebar_label: CWPP API Home
slug: /cloud/cwpp/22-01
---
...
![Expand Body Parameters](https://github.com/PaloAltoNetworks/prisma.pan.dev/static/img/expandingbodyparameters.gif)

#### View API endpoint response parameters

![Expand Response Parameters](https://github.com/PaloAltoNetworks/prisma.pan.dev/static/img/expandingresponse.gif)
...
<div className="row">
  ...
  <Link to="/api/cloud/cwpp/22-01">
    <button className="button button--secondary button--outline button--lg" href="/api/cloud/cwpp/22-01">
        22.01
    </button>
  </Link>
